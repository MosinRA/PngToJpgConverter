...
import com.mosin.pngtojpgconverter.mvp.model.IConverter
import io.reactivex.rxjava3.core.Completable
import io.reactivex.rxjava3.schedulers.Schedulers
import java.io.File
import java.io.FileOutputStream

class ConverterLogic(private val context: Context, private val uri: Uri) : IConverter {

    private var targetFile: File
    private var targetUri: Uri

    init {
        targetFile = File(context.getExternalFilesDir(null), getTargetTextName())
    ...
    override fun getSourceTextName(): String {
        var path: String = ""
